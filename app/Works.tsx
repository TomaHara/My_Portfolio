...
import WorksDetailPage from "./WorksDetail";
import icons from "./iconlist";
import My_Works from "./my_works";
...
const Works = () => {
  const ScreenShot = ({ id }: { id: number }) => {
    ...
    return (
      <>
        ...
        <div
          className={`fixed top-0 left-0 w-full h-screen mobile:h-svh overflow-y-auto flex justify-center items-center z-50 bg-white ${
            isModalOpen ? "" : "hidden"
          }`}
        >
          <button
  ...
  return (
    <section
      className="w-full h-screen shrink-0 relative overflow-hidden flex flex-col items-center justify-center desktop:min-h-[700px] mobile:min-h-[640px]"
      id="Works"
    >
